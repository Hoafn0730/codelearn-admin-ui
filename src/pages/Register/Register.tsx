...
function Register() {
    ...
    const [dataRaw, setDataRaw] = useState<RegisterType | undefined>();
    ...
    useEffect(() => {
        if (Number(searchParams.get('page')) > 0 && !(show || isShowDelete)) {
            registerService.getRegisters({ page: Number(searchParams.get('page')) }).then((res) => {
                setData(res.data);
            });
        }
            ...
            <Container>
                <Row>
                    <Col md={12}>
                        <Row>
                            <Col xs={12} xl={8} md={4}>
                                <h3 className="font-weight-bold title">Register</h3>
                            </Col>
                        </Row>
                    </Col>
                </Row>
                        ...
                        <Card>
                            <Card.Body>
                                <Card.Header className="d-flex justify-content-between bg-light">
                                    <Card.Title>Register Table</Card.Title>
